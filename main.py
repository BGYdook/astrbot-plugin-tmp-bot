...
"""
    ...
    async def tmprank_total(self, event: AstrMessageEvent):
        ...
        rank_tmpl = """
<style>
  html, body { margin:0; padding:0; width:1024px; height:576px; background:#000; font-family: system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; display:flex; align-items:center; justify-content:flex-start; }
  .wrap { width:340px; margin-left:40px; background:linear-gradient(135deg,#1f2f54,#0f2c2a); overflow:hidden; padding-bottom:12px; box-shadow:0 4px 20px rgba(0,0,0,0.5); border-radius:16px; }
